...
vim.keymap.set("n", "<leader>sS", function()
	vim.lsp.buf.workspace_symbol("", function(err, result)
		if not err and result then picker.locations(result, "Workspace Symbols") end
	end)
end, { desc = "LSP Workspace Symbols" })
vim.keymap.set("n", "gai", function()
	vim.lsp.buf.incoming_calls(function(err, result)
		if not err and result then picker.locations(result, "Incoming Calls") end
	end)
end, { desc = "Incoming Calls" })
vim.keymap.set("n", "gao", function()
	vim.lsp.buf.outgoing_calls(function(err, result)
		if not err and result then picker.locations(result, "Outgoing Calls") end
	end)
